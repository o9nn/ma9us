...
#define	OREAD	0x00	/* open for read */
#define	OWRITE	0x01	/* write */
#define	ORDWR	0x02	/* read and write */
#define	OEXEC	0x03	/* execute, == read but check execute permission */
#define	OTRUNC	0x10	/* or'ed in (except for exec), truncate file first */
#define	OCEXEC	0x20	/* or'ed in, close on exec */
#define	ORCLOSE	0x40	/* or'ed in, remove on close */
#define	OAPPEND 0x80		/* 9p2000.u append mode */
...
#define QTAUTH		0x08
#define QTTMP			0x04
#define QTSLINK 		0x02		/* SymLink */
#define QTLINK 		0x01		/* Hard Link */
...
struct Dir {
	...
	char *extension;	/* 9P2000.u unix[s] var string */
	ulong 	n_uid;	/* 9P2000.u numeric userid */
	ulong 	n_gid;	/* 9P2000.u numeric groupid */
	ulong 	n_muid;	/* 9P2000.u numeric last modifier */
} Dir;

long readn(int, void*, long);
void remotehost(char*, int);

long u9fs_write(int, void *, long);
long u9fs_read(int, void *, long);
